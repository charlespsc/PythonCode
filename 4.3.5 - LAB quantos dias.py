...
# Pode ser muito útil. Recomendamos que você use uma lista com os comprimentos dos meses. 
...
#     if year < 1582:
#         return False  # O calendário gregoriano começou em 1582
#     if year % 4 != 0:
#         return False
#     elif year % 100 != 0:
#         return True
...
#     if year < 1582:
#         return None # Ano inválido (antes do calendário gregoriano)
...
#         print("OK")
#     else:
#         print(f"Fracassado (Esperado: {test_results[i]}, Obtido: {result})")
